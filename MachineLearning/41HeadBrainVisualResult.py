...
def MarvellousHeadBrainLinear(Dataset):
    ...
    plt.plot(X_test.values.flatten(), Y_predicted, color = 'red', linewidth = 2, label = 'Regression label')
    ...
    print("Result of case study is")
    print("Slope of line is (m) : ", model.coef_[0])
    print("Y-intercept is (c) : ", model.intercept_)
